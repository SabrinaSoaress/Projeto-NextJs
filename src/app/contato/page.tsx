        ...
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center py-12">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-3xl">
                ...
                <div className="mt-8 text-center">
                    <img src="/iconConnect.jpg" alt="Icone de Contato" className="h-20 inline mb-4" />
                    ...
                    <div className="flex justify-center space-x-6 mt-4">
                        <a href="#" className="text-(--rosa) hover:text-(--roxo)">Facebook</a>
                        <a href="#" className="text-(--rosa) hover:text-(--roxo)">Instagram</a>
                        <a href="#" className="text-(--rosa) hover:text-(--roxo)">LinkedIn</a>
                    </div>
                </div>
            </div>
        </div>
